 ...
 * @date 04/2014
 */
public class CircularCounterBak extends View {
	...
	public CircularCounterBak(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public CircularCounterBak setRange(int range) {
		mRange = range;
		return this;
	}

	public CircularCounterBak setFirstWidth(float width) {
		mOneWidth = width;
		return this;
	}

	public CircularCounterBak setSecondWidth(float width) {
		mTwoWidth = width;
		return this;
	}

	public CircularCounterBak setThirdWidth(float width) {
		mThreeWidth = width;
		return this;
	}

	public CircularCounterBak setTextSize(float size) {
		mTextSize = size;
		return this;
	}

	public CircularCounterBak setMetricSize(float size) {
		mMetricSize = size;
		return this;
	}

	public CircularCounterBak setFirstColor(int color) {
		mOneColor = color;
		return this;
	}

	public CircularCounterBak setSecondColor(int color) {
		mTwoColor = color;
		return this;
	}

	public CircularCounterBak setThirdColor(int color) {
		mThreeColor = color;
		return this;
	}

	public CircularCounterBak setTextColor(int color) {
		mTextColor = color;
		return this;
	}

	public CircularCounterBak setMetricText(String text) {
		mMetricText = text;
		return this;
	}
	...
	public CircularCounterBak setTypeface(Typeface typeface) {
		mTypeface = typeface;
		return this;
	}
	...
	private static class SpeedHandler extends Handler {
		...
		private CircularCounterBak act;

		public SpeedHandler(CircularCounterBak act) {
			super();
			this.act = act;
		}
